...
class GeometryController(ControllerBase):
    ...
    def _initialize_controller(self):
        self.K_pos = self._parameter_manager.get_param('K_pos').copy()
        self.K_vel = self._parameter_manager.get_param('K_vel').copy()
        self.K_ori = self._parameter_manager.get_param('K_ori').copy()
        self.K_ang_vel = self._parameter_manager.get_param('K_ang_vel').copy()
    ...
    def _compute_control(self) -> ControllerOutput:
        ...
        self._output.thrust = force.copy()
        self._output.torque = torque.copy()
